...
public class EngineEvent5 : MonoBehaviour
{
    ...
    Text levelEndText;
    public Dialogue5 questionScript;
    ...
    void Awake()
    {
        ...
        hSpawner = GameObject.Find("GameHandler").GetComponent<HazardSpawner5>();
    }
    ...
    IEnumerator EndLevel()
    {
        ...
        if (scoreScript.score >= 2000 && scoreScript.score < 3000)
        {
            ...
            int badgeCount = sceneSaver.GetBadgeCount(5);
            if (badgeCount < 1)
